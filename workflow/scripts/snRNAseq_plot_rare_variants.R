...
##Produce final plots for lvl1 --------------------------------------------------------
 ...
 jpeg(file = paste0(fig_dir, 'wilcoxon_herring_lvl', level, '_plot.jpeg'), units = "in", width = 6, height = 11, res = 300)
 plot(WILCOXON_PLOT)
 dev.off()
...
##Produce final plots for lvl2 --------------------------------------------------------
 ...
 jpeg(file = paste0(fig_dir, 'wilcoxon_herring_lvl', level, '_plot.jpeg'), units = "in", width = 11, height = 11, res = 300)
 plot(WILCOXON_PLOT)
 dev.off()
