...
# Cell counts
cell_counts_lvl_1 <- as.data.frame(table(seurat_herring@meta.data$major_clust))
...
seurat_herring_dwnSmpl_lvl1  <- subset(seurat_herring_dwnSmpl_lvl1, downsample = min(table(seurat_herring$major_clust)))
table(seurat_herring_dwnSmpl_lvl1@meta.data$major_clust)

# Level 2 - sub clusters - downsampled to 300 cells - 76/84 have >300 cells
...
## Save RDS objects  ------------------------------------------------------------------
saveRDS(object = seurat_herring_dwnSmpl_lvl1, paste0(r_dir, 'seurat_herring_dwnSmpl_lvl1.rds'))
