...
LEVEL <- snakemake@input[[3]] #3rd wildcard?
...
#assign(paste0('magma_', GWAS, '.', study_id, '_lvl_', LEVEL, '_df'), MAGMA_DF, envir = .GlobalEnv)
#assign(paste0('magma_', GWAS, '.', study_id, '_lvl_', LEVEL, '_plot'), MAGMA_PLOT, envir = .GlobalEnv)
...
#assign(paste0('ldsr_', GWAS, '.', study_id, '_lvl_', LEVEL, '_df'), LDSR_DF, envir = .GlobalEnv)
#assign(paste0('ldsr_', GWAS, '.', study_id, '_lvl_', LEVEL, '_full_df'), LDSR_FULL_DF, envir = .GlobalEnv)
#assign(paste0('ldsr_', GWAS, '.', study_id, '_lvl_', LEVEL, '_plot'), LDSR_PLOT, envir = .GlobalEnv)
...
#assign(paste0(GWAS, '_magma_ldsr_', study_id, '_lvl_', LEVEL, '_plot'), MAGMA_LDSR_PLOT, envir = .GlobalEnv)
...
#assign(paste0(GWAS, '_magma_ldsr_mean_', study_id, 'lvl_', LEVEL, '_plot'), MAGMA_LDSR_MEAN_PLOT, envir = .GlobalEnv)
...
jpeg(file = paste0(fig_dir, GWAS, '_magma_ldsr_mean_', study_id, end, '_plot.jpeg'), units = "in", width = 11, height = 11, res = 300)
plot(MAGMA_LDSR_MEAN_PLOT)
dev.off()

jpeg(file = paste0(fig_dir, GWAS, '_magma_ldsr_', study_id, end, '_plot.jpeg'), units = "in", width = 11, height = 11, res = 300)
