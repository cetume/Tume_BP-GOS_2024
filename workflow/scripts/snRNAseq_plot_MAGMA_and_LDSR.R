...
TRAIT <- 'SCZ_EUR_ONLY'
PROJECTS <- c('herring', 'herring_top2000', 'herring_protein_coding', 'herring_nonprotein_coding')
level <- '2'
...
legend <- get_legend(SCZ_EUR_ONLY_magma_ldsr_herring_lvl2_plot)

#Title plots
SCZ_EUR_ONLY_magma_ldsr_herring_lvl2_plot <- SCZ_EUR_ONLY_magma_ldsr_herring_lvl2_plot + ggtitle("Schizophrenia")

SCZ_EUR_ONLY_magma_ldsr_herring_protein_coding_lvl2_plot <- SCZ_EUR_ONLY_magma_ldsr_herring_protein_coding_lvl2_plot + ggtitle("Schizophrenia
Protein-coding Genes")

SCZ_EUR_ONLY_magma_ldsr_herring_nonprotein_coding_lvl2_plot <- SCZ_EUR_ONLY_magma_ldsr_herring_nonprotein_coding_lvl2_plot + ggtitle("Schizophrenia
Non-coding Genes")

SCZ_EUR_ONLY_magma_ldsr_herring_top2000_lvl2_plot <- SCZ_EUR_ONLY_magma_ldsr_herring_top2000_lvl2_plot + ggtitle("Top 2000 Genes")

#Combine plots
SCZ_EUR_ONLY_coding_genes_plot <- plot_grid(SCZ_EUR_ONLY_magma_ldsr_herring_protein_coding_lvl2_plot + NoLegend(),
                                            SCZ_EUR_ONLY_magma_ldsr_herring_nonprotein_coding_lvl2_plot + NoLegend(),
                                            legend, ncol = 3, rel_widths = c(1, 1, 0.4),
                                            labels = c('A', 'B', ''), label_size = 20)

#Save plots
jpeg(file = paste0(FIG_DIR,'SCZ_EUR_ONLY_magma_ldsr_herring_lvl2_plot.jpeg'), units = "in", width = 8.75, height = 22, res = 300)
plot(SCZ_EUR_ONLY_magma_ldsr_herring_lvl2_plot)
dev.off()

jpeg(file = paste0(FIG_DIR,'SCZ_EUR_ONLY_magma_ldsr_herring_top2000_plot.jpeg'), units = "in", width = 8.75, height = 22, res = 300)
plot(SCZ_EUR_ONLY_magma_ldsr_herring_top2000_lvl2_plot)
dev.off()

jpeg(file = paste0(FIG_DIR, 'SCZ_EUR_ONLY_magma_ldsr_herring_protein_nonprotein_coding_plot.jpeg'), units = "in", width = 15, height = 22, res = 300)
plot(SCZ_EUR_ONLY_coding_genes_plot)
dev.off()
