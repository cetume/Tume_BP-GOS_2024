rule ldsr_stratified_baseline_v12_internal_cond:
    ...
    output:  "../results/LDSR_part_herit/baseline_v1.2/herring_conditional/snRNAseq.{COND_CELL_A}_vs_{COND_CELL_B}.SCZ_baseline.v1.2.results"
    conda:   "../envs/ldsr.yml"
    params:  weights = "../resources/ldsr/reference_files/weights_hm3_no_hla/weights.",
             ...
             out_file = "../results/LDSR_part_herit/baseline_v1.2/herring_conditional/snRNAseq.{COND_CELL_A}_vs_{COND_CELL_B}.SCZ_baseline.v1.2"
    message: "Running Prt Hrt with {wildcards.COND_CELL_A} vs. {wildcards.COND_CELL_B}, 100UP_100DOWN and SCZ"
    log:     "../results/00LOG/LDSR/herring_conditional/snRNAseq.{COND_CELL_A}_vs_{COND_CELL_B}.SCZ.baseline.v1.2_partHerit.log"
    shell:
             """
...
rule ldsr_stratified_summary_internal_cond:
    input:   expand("../results/LDSR_part_herit/baseline_v1.2/herring_conditional/snRNAseq.{COND_CELL_A}_vs_{COND_CELL_B}.SCZ_baseline.v1.2.results", COND_CELL_A = config['COND_CELL_A'], COND_CELL_B = config['COND_CELL_B'])
    output:  "../results/LDSR_part_herit/baseline_v1.2/herring_conditional/snRNAseq_LDSR_SCZ_baseline.v1.2_summary.tsv"
    message: "Creating internal conditional summary file for SCZ"
    params:  dir = "../results/LDSR_part_herit/baseline_v1.2/herring_conditional/",
    ...
    shell:
             ...
             for Line in $Lines
             do
             grep L2_2 ../results/LDSR_part_herit/baseline_v1.2/herring_conditional/snRNAseq."$Line".SCZ_baseline.v1.2.results | sed "s/L2_2/$Line/g" >> {output} 2> {log}
             done
