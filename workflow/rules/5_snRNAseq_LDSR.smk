...
rule ldsr_ld_scores:
    input:   annot = "../results/LDSR_annotation_files/herring/snRNAseq.{CELL_TYPE}.{CHR}.annot.gz",
    ...
    output:  "../results/LDSR_annotation_files/herring/snRNAseq.{CELL_TYPE}.{CHR}.l2.ldscore.gz"
    resources: slurm_extra = "--use-conda"
    conda:   "../envs/ldsr.yml"
    params:  bfile = "../resources/ldsr/reference_files/1000G_EUR_Phase3_plink/1000G.EUR.QC.{CHR}",
             ldscores = "../results/LDSR_annotation_files/herring/snRNAseq.{CELL_TYPE}.{CHR}",
    ...
    log:     "../results/00LOG/LDSR/herring/ld_scores.snRNAseq.{CELL_TYPE}.Chr{CHR}.log"
    shell:
...
rule ldsr_stratified_baseline_v12:
    input:   GWAS = "../results/GWAS_for_ldsc/{GWAS}_hg19_ldsc_ready.sumstats.gz",
             LDSR = expand("../results/LDSR_annotation_files/herring/snRNAseq.{CELL_TYPE}.{CHR}.l2.ldscore.gz", project = config["project"],  CELL_TYPE = config["CELL_TYPE"], CHR = range(1,23))
    output:  "../results/LDSR_part_herit/baseline_v1.2/herring/snRNAseq.{CELL_TYPE}.{GWAS}_baseline.v1.2.results"
    resources: slurm_extra = "--use-conda"
    conda:   "../envs/ldsr.yml"
    params:  weights = "../resources/ldsr/reference_files/weights_hm3_no_hla/weights.",
             ...
             LD_anns = "../results/LDSR_annotation_files/herring/snRNAseq.{CELL_TYPE}.",
             out_file = "../results/LDSR_part_herit/baseline_v1.2/herring/snRNAseq.{CELL_TYPE}.{GWAS}_baseline.v1.2"
    message: "Running Prt Hrt with {wildcards.CELL_TYPE} and {wildcards.GWAS} GWAS"
    log:     "../results/00LOG/LDSR/herring/snRNAseq.{CELL_TYPE}.{GWAS}.baseline.v1.2_partHerit.log"
    shell:
...
rule ldsr_stratified_summary:
    input:   LDSR = expand("../results/LDSR_part_herit/baseline_v1.2/herring/snRNAseq.{CELL_TYPE}.{GWAS}_baseline.v1.2.results", project = config["project"], CELL_TYPE = config["CELL_TYPE"], GWAS = config["GWAS"])
    output:  "../results/LDSR_part_herit/baseline_v1.2/herring/snRNAseq_LDSR_{GWAS}_baseline.v1.2_summary.tsv"
    resources: slurm_extra = "--use-conda"
    ...
    log:     "../results/00LOG/LDSR/herring/snRNAseq.{GWAS}_baseline.v1.2_partHerit.summary.log"
    shell:
             """
