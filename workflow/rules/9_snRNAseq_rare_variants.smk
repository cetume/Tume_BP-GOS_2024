rule rare_variants:
    ...
    log:    "../results/00LOG/rare_variants/snRNAseq_rare_variants.log"
    script:
...
rule plot_rare_variants:
    ...
    log:    "../results/00LOG/rare_variants/snRNAseq_plot_rare_variants.log"
    script:
...
rule plot_rare_variants_dwnSmpl:
    ...
    params: fig_dir = "../results/figures/",
            level = "{LEVEL}"
    log:    "../results/00LOG/rare_variants/snRNAseq_plot_rare_variants_dwnSmpl.log"
    script:
